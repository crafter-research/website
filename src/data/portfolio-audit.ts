...
export const portfolioAudit: PortfolioAuditRecord[] = [
	...
	},
	{
		...
		limitation: {
			en: "Only one census run exists, so repeatability across time is not established.",
			es: "Solo existe una corrida censal, por lo que la repetibilidad temporal no está establecida.",
		},
		proof: [
			{
				en: "1,794 municipalities · 95.5% coverage",
				es: "1,794 municipalidades · 95.5% de cobertura",
			},
			{
				en: "Method, limitations, citation, and data published",
				es: "Método, límites, cita y datos publicados",
			},
		],
		scores: { activity: 4, consistency: 1, output: 4 },
		metrics: { commits: 6, activeWeeks: 1, releases: 0 },
		lastActivity: "2026-08-09",
		verifiedAt: "2026-08-21",
	},
	{
